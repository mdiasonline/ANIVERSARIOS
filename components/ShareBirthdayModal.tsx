...
const ShareBirthdayModal: React.FC<ShareBirthdayModalProps> = ({ birthday, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
            <div className="bg-white dark:bg-[#1f1f1f] rounded-3xl w-full max-w-sm max-h-[90vh] flex flex-col shadow-2xl relative">
                ...
                {/* Header */}
                <div className="p-4 sm:p-6 text-center pb-2 shrink-0">
                ...
                {/* Preview Area (Scrollable if needed, scalable) */}
                <div className="flex-1 overflow-y-auto overflow-x-hidden flex justify-center p-2 sm:p-4 bg-gray-50 dark:bg-black/20">
                    <div className="origin-top transform scale-[0.70] sm:scale-90 md:scale-100 transition-transform -mb-[160px] sm:-mb-[60px] md:mb-0">
                        <div
                            ref={cardRef}
                            className="relative w-[340px] h-[580px] bg-[#fbf5e9] overflow-hidden shadow-lg flex flex-col items-center pt-6 shrink-0"
                        >
                            ...
                            <div className="relative z-30 flex flex-col items-center text-center mt-2 w-full px-6">
                                ...
                                {/* Name */}
                                <h1 className="text-[#3e342b] font-serif font-medium text-6xl tracking-wide mb-1">
                ...
                {/* Actions */}
                <div className="p-4 sm:p-6 pt-2 flex flex-col gap-2 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] z-20 bg-white dark:bg-[#1f1f1f] shrink-0">
                    <button
                        onClick={handleShare}
                        disabled={loading}
